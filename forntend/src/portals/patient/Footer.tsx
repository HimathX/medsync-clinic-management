...
export default function PatientFooter(): React.ReactElement {
  ...
  const quickLinks = [
    ...
    { label: 'Bokk Appointments', href: '/patient/book-appointment' }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <h3 className="text-xl font-bold text-foreground">MediSync</h3>
              <p className="text-sm text-muted-foreground">
                Professional healthcare management platform for doctors and patients.
              </p>
            </div>
