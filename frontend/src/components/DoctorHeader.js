 ...
 * Navigation header specifically for doctors
 * Shows doctor-relevant menu items only
 */
const DoctorHeader = ({ doctorName, branch, setBranch, onLogout }) => {
  const navLinks = [
  ...
  return (
    <header className="ms-header" aria-label="Site header">
      <div className="ms-topbar">
        <Link to="/doctor/dashboard" className="ms-brand" aria-label="MedSync home">
        ...
        <div className="ms-actions">
          <span className="ms-chip" title="Role" style={{background: '#10b981', color: 'white'}}>
