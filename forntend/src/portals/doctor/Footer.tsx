...
export default function DoctorFooter(): React.ReactElement {
  ...
  const quickLinks = [
    ...
    { label: "Treatments", href: "/doctor/treatments" },
  ];
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Professional healthcare management platform for doctors and
                patients.
              </p>
            </div>
